...
## 2026-07-30 01:44 HKT

- Current work: Rebuild and revalidate from the fast-forwarded final `main` commit so the hardware-tested bytes, release checksums, and public manifest share one source state.
