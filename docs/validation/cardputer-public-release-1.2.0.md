...
- Python release tests: 222 passed.
...
- ESP32-S3 firmware application size: `0x18c420` bytes with 48% of the
  smallest application partition free.
- Firmware static size: 1,622,921 bytes; DIRAM headroom: 143,497 bytes.
...
- Security audit: 7 refs, 200 reflog commits, 17 retained unreachable
  objects, 1,400 Git blobs and 445 current/artifact files scanned; 0 findings.
...
| `dist/cardputer_codex_companion.bin` | `431d79d77c6db07bc18222ece1b214e48ccd12c12857bac4f683dfc3e998b3ef` |
| `dist/cardputer_codex_companion-full.bin` | `90c9b375bfdd3c4b45a5aef6dbabbbe160aad077bc80bdf1a51db4fd7c81a8fa` |
...
| `dist/CardputerCompanion-1.2.0-windows-x64-setup.exe` | `e5774275dc109e7129afab00edc00de904b6a90030b42d12f3c49f5664888768` |
