...
def test_dual_firmware_artifacts_are_public() -> None:
    assert {
        "Cardputer-Codex-Companion-1.3.5-factory.bin",
        "Cardputer-Codex-Companion-1.3.5-app.bin",
        "Cardputer-Codex-Companion-1.3.5l-launcher.bin",
...
def test_public_readme_is_english_first_and_bilingual():
    ...
    for document in (readme, chinese):
        ...
        assert "1.3.5" in document
        assert "1.3.5l" in document
        assert "2.8.0" in document
        assert "Cardputer-Codex-Companion-1.3.5-factory.bin" in document
        assert "Cardputer-Codex-Companion-1.3.5l-launcher.bin" in document
    assert (
