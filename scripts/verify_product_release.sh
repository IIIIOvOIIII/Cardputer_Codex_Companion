...
test -f dist/CardputerCompanion-1.2.1-windows-amd64.zip
test -f dist/CardputerCompanion-1.2.1-windows-arm64.zip
test -f dist/CardputerCompanion-1.2.1-windows-x64-setup.exe
...
shasum -a 256 \
  ...
  dist/CardputerCompanion-mac-installer/installer/mac_installer.py \
  dist/CardputerCompanion-1.2.1-windows-amd64.zip \
  dist/CardputerCompanion-1.2.1-windows-arm64.zip \
  dist/CardputerCompanion-1.2.1-windows-x64-setup.exe \
