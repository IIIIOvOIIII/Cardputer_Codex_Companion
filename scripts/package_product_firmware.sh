...
factory_versioned="${repo_root}/dist/Cardputer-Codex-Companion-1.3.3-factory.bin"
factory_app="${repo_root}/dist/cardputer_codex_companion.bin"
factory_app_versioned="${repo_root}/dist/Cardputer-Codex-Companion-1.3.3-app.bin"
launcher_output="${repo_root}/dist/Cardputer-Codex-Companion-1.3.3l-launcher.bin"
